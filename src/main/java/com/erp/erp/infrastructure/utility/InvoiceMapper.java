...
public class InvoiceMapper {
  ...
  public static InvoiceResponseDto toDto(Invoice invoice) {
    ...
    return InvoiceResponseDto.builder()
        ...
        .documentType(optionalTicket.map(Ticket::getType).orElse(null))
        .customerDocumentId(optionalTicket.map(Ticket::getCustomerDocumentId).orElse(null))
  ...
  public static InvoiceResponseDto mapToInvoiceResponseDto(Invoice invoice) {
    ...
    return InvoiceResponseDto.builder()
        ...
        .gstId(invoice.getGstId())
        .documentType(invoice.getType())
        .customerDocumentId(invoice.getCustomerDocumentId())
